package org.papervision3d.objects.parsers {
	...
	public class MD2 extends TriangleMesh3D implements IAnimatable, IAnimationProvider, IControllerProvider
	{
		...
		/**
		 * Gambiarra pra adicionar animação no boneco
		 */
		public function addAnimationClip(name, initFrame, endFrame)
		{
			var duration:Number = 1 / _fps;
			var clip = new AnimationClip3D(name, initFrame * duration, endFrame * duration);
			this._animation.addClip(clip);
		}
	}
}
